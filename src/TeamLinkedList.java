    ...
    public void sort() {
        ...
        do {
            ...
            while (current.next != null) {
                ...
                Team nextTeam = current.next.team;
                
                boolean shouldSwap = false;
                
                if (currentTeam.getPoints() < nextTeam.getPoints()) {
                    shouldSwap = true;
                } else if (currentTeam.getPoints() == nextTeam.getPoints()) {
                    if (currentTeam.getGoalDifference() < nextTeam.getGoalDifference()) {
                        shouldSwap = true;
                    } else if (currentTeam.getGoalDifference() == nextTeam.getGoalDifference()) {
                                    if (currentTeam.getName().compareToIgnoreCase(nextTeam.getName()) > 0) {
                            shouldSwap = true;
                        }
                    }
                }
